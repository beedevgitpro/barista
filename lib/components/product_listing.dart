...
class ProductListing extends StatelessWidget {
  ProductListing({this.size,this.productName,this.img,this.price,@required this.regularPrice});
  final double size;
            ...
            Text(productName,style:TextStyle(
                      fontFamily: kDefaultFontFamily,
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              Text(int.parse(regularPrice)>int.parse(price)?'\$$regularPrice':'',style:TextStyle(
                      fontFamily: kDefaultFontFamily,
