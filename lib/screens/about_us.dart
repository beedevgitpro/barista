      ...
      child: Scaffold(
        ...
        body: SafeArea(
          ...
          children: [
            ...
            SizedBox(height: 8),
            for(String listItem in ['High quality products at competitive prices','Excellent customer service','Safe and secure member login','User-friendly shopping','Range of payment options','Same-day dispatch (Orders placed before 3pm AEST)','Order tracking','Flat rate \$10 standard shipping* (excluding International and Express orders)'])
            Padding(padding:EdgeInsets.only(left: 12.0,right: 8,top:10),
            child: Row(
              children: [
                Align(
                ...
                Expanded(
                    child: Text('$listItem',style: TextStyle(
                    fontFamily: kDefaultFontFamily,
                    color: Colors.black54,
                    fontSize: _large ? 18 : 16,
                  ),),
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 8.0),
              child: Text(
                'Become a Wholesale Account Member today',
                textAlign: TextAlign.justify,
                style: TextStyle(
                  fontFamily: kDefaultFontFamily,
                  color: kPrimaryColor,
