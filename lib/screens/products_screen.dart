              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        FlatButton(
                          ...
                          onPressed: () {
                            AddToCartRequestModel addToCartRequestModel =
                                new AddToCartRequestModel(
                                    productId: product.id.toString(),
                                    quantity: qty);
                            var prLoader = Loader(context);
                            prLoader.show();
                            Provider.of<CartProvider>(context, listen: false)
                                .addCartItem(addToCartRequestModel)
                                .then((value) {
                              prLoader.hide();
                              if (value) {
                                showAddToCartSheet(context);
                              } else {
                                _productScreenKey.currentState.showSnackBar(
                                    SnackBar(
                    ...
                    FlatButton(
                      onPressed: () {
                        Provider.of<WishlistModel>(context, listen: false).add(
                            product.id.toString(),
                            qty,
                            product.price.toString());
                        _productScreenKey.currentState.showSnackBar(SnackBar(
